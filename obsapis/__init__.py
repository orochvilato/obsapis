...
from views import deputes,votes,interventions,svgs,logs,scrutins,groupes,visuels,extractions,commissions,charts,admin,obsgouv,graphes,specifique,visuel
